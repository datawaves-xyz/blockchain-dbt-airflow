{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function opensea_openseaensresolver_setabi_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_OpenSeaENSResolver_setABI_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf.jar";'
        }
    )
}}
