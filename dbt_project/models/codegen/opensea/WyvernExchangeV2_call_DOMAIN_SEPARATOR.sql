{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function opensea_wyvernexchangev2_domain_separator_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_WyvernExchangeV2_DOMAIN_SEPARATOR_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf.jar";'
        }
    )
}}
