...
with base as (
    select
        ...
        dt,
        curve_husdswap_transfer_ownership_deadline_calldecodeudf(unhex_input, unhex_output, '{"name": "transfer_ownership_deadline", "outputs": [{"type": "uint256", "name": ""}], "inputs": [], "stateMutability": "view", "type": "function", "gas": 2561}', 'transfer_ownership_deadline') as data
