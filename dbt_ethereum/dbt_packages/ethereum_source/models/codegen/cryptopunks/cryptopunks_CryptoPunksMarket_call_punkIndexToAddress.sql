...
with base as (
    select
        ...
        dt,
        cryptopunks_cryptopunksmarket_punkindextoaddress_calldecodeudf(unhex_input, unhex_output, '{"constant": true, "inputs": [{"name": "", "type": "uint256"}], "name": "punkIndexToAddress", "outputs": [{"name": "", "type": "address"}], "payable": false, "type": "function"}', 'punkIndexToAddress') as data
