{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function foundation_market_implementation_calldecodeudf as "io.iftech.sparkudf.hive.Foundation_market_implementation_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.0.jar";'
        }
    )
}}
