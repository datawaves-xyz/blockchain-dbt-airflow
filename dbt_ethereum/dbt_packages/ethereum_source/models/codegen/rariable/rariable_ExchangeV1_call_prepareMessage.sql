{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function rariable_exchangev1_preparemessage_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV1_prepareMessage_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.0.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0x30783034"
    and selector_hash = abs(hash("0x30783034")) % 10
