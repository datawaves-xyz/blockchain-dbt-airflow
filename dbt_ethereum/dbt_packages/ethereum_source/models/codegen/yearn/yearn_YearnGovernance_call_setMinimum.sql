{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function yearn_yearngovernance_setminimum_calldecodeudf as "io.iftech.sparkudf.hive.Yearn_YearnGovernance_setMinimum_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.0.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0x30783332"
    and selector_hash = abs(hash("0x30783332")) % 10
