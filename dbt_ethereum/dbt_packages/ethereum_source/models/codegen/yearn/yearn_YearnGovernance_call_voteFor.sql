{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function yearn_yearngovernance_votefor_calldecodeudf as "io.iftech.sparkudf.hive.Yearn_YearnGovernance_voteFor_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.0.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0x30783836"
    and selector_hash = abs(hash("0x30783836")) % 10
